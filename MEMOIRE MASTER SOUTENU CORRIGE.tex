...
Le modèle de type Bloch décrit donc l'évolution temporelle des probabilités de présence des particules dans ces systèmes quantiques qui sont soit des ﬁls quantiques, soit des puits quantiques, soit les boîtes quantiques selon le confinement des particules. 
...
\subsubsection{Première quantiﬁcation} 
...
\subsubsection{Seconde quantiﬁcation} 
Dans le formalisme de la seconde quantiﬁcation, la variable d’état $ \psi(r,t)$ et son adjoint
...
Les termes dans les différentes sommes sont appelés les paramètres de Coulomb et dépendent des fonctions propres des diﬀérents états d'énergies du système quantique.\\
...
Dans la thèse \cite{mareference1} (page 67), l’hermicité est une propriété très importante de la matrice densité car elle permet notamment d’aﬃrmer que les cohérences qui sont les éléments $\rho_{jk}^{\delta}$ et $\rho_{kj}^{\delta}$ pour tout $j \neq k$ ont les mêmes modules, c'est à dire que les probabilités de transition j vers k et k vers j sont identiques.\\
...
&\quad +i\Bigg[ (R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})\Big[\rho_{33}\Im(\rho_{12})-\Re(\rho_{23})\Im(\rho_{13})+\Re(\rho_{13})\Im(\rho_{23})\Big] + \\
&\quad \Im(R^{\textsc{c-v}}_{3132})\Big[\rho_{22}\rho_{33}-\rho_{11}\rho_{33}-\Re^{2}(\rho_{23})-\Im^{2}(\rho_{23})+\Re^{2}(\rho_{13})+\Im^{2}(\rho_{13})\Big]\Bigg]
\end{split}
\end{eqnarray*}
...
\begin{eqnarray*}
\begin{split}
P^{N}(\rho)_{12} &=\dfrac{1}{\hbar}\Bigg[ (R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})\Big[\rho_{33}\Im(\rho_{12})-\Re(\rho_{23})\Im(\rho_{13})+\Re(\rho_{13})\Im(\rho_{23})\Big] + \\
&\quad \Im(R^{\textsc{c-v}}_{3132})\Big[\rho_{22}\rho_{33}-\rho_{11}\rho_{33}-\Re^{2}(\rho_{23})-\Im^{2}(\rho_{23})+\Re^{2}(\rho_{13})+\Im^{2}(\rho_{13})\Big]\Bigg]\\
...
\left\{
\begin{split}
\Re(P^{N}(\rho)_{12}) &= \dfrac{1}{\hbar}\Bigg[ (R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})\Big[\rho_{33}\Im(\rho_{12})-\Re(\rho_{23})\Im(\rho_{13})+\Re(\rho_{13})\Im(\rho_{23})\Big] + \\
&\quad \Im(R^{\textsc{c-v}}_{3132})\Big[\rho_{22}\rho_{33}-\rho_{11}\rho_{33}-\Re^{2}(\rho_{23})-\Im^{2}(\rho_{23})+\Re^{2}(\rho_{13})+\Im^{2}(\rho_{13})\Big]\Bigg]\\
\Im(P^{N}(\rho)_{12})&=  -\dfrac{1}{\hbar}\big[-\Re(R^{\textsc{c-v}}_{3132})\rho_{33}\rho_{11}+\Re(R^{\textsc{c-v}}_{3132})\rho_{33}\rho_{22}\big]\\
&\quad -\dfrac{1}{\hbar}\Big[(R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})\rho_{33}\Re(\rho_{12})+[\Re(R^{\textsc{c-v}}_{3132})\Re^{2}(\rho_{13})\\
...
\begin{pmatrix}
-\Im(R^{\textsc{c-v}}_{3132})U_{3} & \Im(R^{\textsc{c-v}}_{3132})U_{3} & (R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})U_{7}\\
...
\begin{pmatrix}
0 & -(R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})U_{6}+\Im(R^{\textsc{c-v}}_{3132})U_{8} & (R^{\textsc{c-v}}_{3131}-R^{\textsc{c-v}}_{3232})U_{5}-\Im(R^{\textsc{c-v}}_{3132})U_{9} \\
...
Par le théorème de point ﬁxe de Banach-Picard, $\mathcal{T}$  admet un unique point ﬁxe sur $[0;\tau[$; alors le problème de Cauchy (S) admet une unique solution définie sur $[0,\min\{\frac{1}{\mu},\frac{\delta}{K}\}[ .$
